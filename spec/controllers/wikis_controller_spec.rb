...
RSpec.describe WikisController, type: :controller do
  ...
  context "premium user doing CRUD on a wiki they don't own" do
    before do
      premium = User.create!(email: Faker::Internet.email, username: Faker::Lorem.word, password: Faker::Internet.password, role: :premium)
      sign_in premium
    end
  ...
  context "admin user doing CRUD on a wiki they don't own" do
    before do
      admin = User.create!(email: Faker::Internet.email, username: Faker::Lorem.word, password: Faker::Internet.password, role: :admin)
      sign_in admin
    end
